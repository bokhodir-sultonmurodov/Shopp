 ...
 useEffect(() => {
  ...
  return (
    <div className="w-full">
      <Herro title="Your Shopping Cart" />
      ...
      {!cart.length ? (
        ...
        <div className="w-full flex flex-col lg:flex-row justify-between gap-10 px-4 sm:px-8 lg:px-16 py-10">
          ...
          <div className="w-full lg:w-[30%] bg-[#F9F1E7] p-8 rounded-md shadow-sm h-fit">
            ...
            <button onClick={()=>navigate("/chekout")} className="w-full py-3 border border-black rounded-md text-sm font-medium hover:bg-black hover:text-white transition duration-200">
              Check Out
            </button>
          </div>
        </div>
